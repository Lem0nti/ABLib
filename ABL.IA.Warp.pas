      ...
      try
        ...
        begin
          ...
          if srcQuad[0].x+srcQuad[0].y=0 then
            exit;
          //âûñ÷èòûâàåì ðàçìåðû èòîãîâîé êàðòèíêè
          ...
          //ðàçìåðû ðåçóëüòàòà äîëæíû áûòü êðàòíû 4
          while FWidth mod 4 = 0 do
            inc(FWidth);
          //äèñêðåòíûå øàãè ïî ïåðèìåòðó âûäåëåííîãî ÷åòûð¸õóãîëüíèêà
          //äåëüòû äëÿ ëåâîé ãðàíèöû
          exLeft.X:=(srcQuad[3].X-srcQuad[0].X)/FHeight;
          exLeft.Y:=(srcQuad[3].Y-srcQuad[0].Y)/FHeight;
          //äåëüòû äëÿ ïðàâîé ãðàíèöû
